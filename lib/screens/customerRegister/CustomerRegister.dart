              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      controller:
                          CustomerRegisterCubit.get(context).nameController,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      controller:
                          CustomerRegisterCubit.get(context).emailController,
                      cursorColor: Colors.grey,
                      cursorHeight: 30,
                      decoration: InputDecoration(
                        labelText: ('  E-mail'),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      controller:
                          CustomerRegisterCubit.get(context).passwordController,
                      cursorColor: Colors.grey,
                      cursorHeight: 30,
                      decoration: InputDecoration(
                        labelText: ('  Password'),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      controller:
                          CustomerRegisterCubit.get(context).phoneController,
                      cursorColor: Colors.grey,
                      cursorHeight: 30,
                      decoration: InputDecoration(
                        labelText: ('  Phone'),
                ...
                MaterialButton(
                  onPressed: () {
                    if(form_key.currentState!.validate()){
                      CustomerRegisterCubit.get(context).userRegister();
                    }
                  },
